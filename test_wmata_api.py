...
class WMATATest(unittest.TestCase):
    ...
    def test_http_success(self):
        ...
        assert escalator_response == 200, "Response not 200."
        ...
        assert elevator_response == 200, "Response not 200."
################################################################################
    ...
    def test_required_fields(self):
        ...
        for incident in json_response:
            for field in required_fields:
                assert field in incident, f"{field} field not found."
################################################################################
    ...
    def test_escalators(self):
        ...
        for incident in json_response:
            assert incident["UnitType"] == "ESCALATOR", "Unit Type not ESCALATOR"
################################################################################
    ...
    def test_elevators(self):
        ...
        for incident in json_response:
            assert incident["UnitType"] == "ELEVATOR", "Unit Type not ELEVATOR"
